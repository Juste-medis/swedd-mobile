...
export default Fiches = () => {
  const collectteurfield = {
      ...
      values: Globals.PROFIL_INFO.collecteursListe,
    },
    formationfield = {
      ...
      multiple: false,
      searchInputPlaceholder: 'Veillez sélectionner la formation',
      values: Globals.PROFIL_INFO.formations,
    };
  return [
    {
      id: 1,
        ...
        return [
          [
            ...
            ...depconarron,
            {
              ...
              label: 'Village',
              placeholder:
                'Veuillez écrire le village de provenance de la fille',
              maxlength: 100,
            },
          ],
          [
          ...
          [
            ...
            },
            {
              ...
              placeholder:
                "Veuillez entrer l'âge exacte de l'enfant enregistré",
              required: true,
              subtype: 'numeric',
              maxlength: 100,
              type: 'text',
          ...
          [
            {
              ...
              type: 'header',
              subtype: 'h3',
              label: "Informations relatives à la personne affiliée à l'enfant",
              style: styles.sectionTitleStyle,
            },
            {
              key: 'nomPersonneAffilier',
        ...
        return [
          ...
          [
            ...
            },
            {
              ...
              label: 'Régularité',
              placeholder:
                'Veuillez préciser la régularité de la fille au cours',
              maxlength: 100,
              type: 'text',
              required: true,
            },
        ...
        return [
          ...
          [
            ...
            },
            {
              ...
              label: 'Fratrie',
              placeholder:
                "Veuillez indiquer si l'enfant à des frères ou sœurs",
              type: 'radio-group',
              other: false,
              required: true,
              values: [
    ...
    },
    {
      id: 6,
      title:
        "FICHE D'IDENTIFICATION DES FILLES (Maintien des filles à l'école)",
      meta_thing: 'Natacha C. G. BAMEYNOU',
      icon: icons[generateRandom(icons.length)],
      variant: variants[generateRandom(variants.length)],
      get description() {
    ...
    },
    {
      ...
      get content() {
        const kitTable = [
          ...
          {
            key: 'beneficiairerecukit',
            type: 'paragraph',
            label: 'La fille a t-elle reçu?',
          },
        ];
        for (let ki = 0; ki < Globals.PROFIL_INFO.kitsList.length; ki++) {
          ...
          kitTable.push(
            ...
            {
              key: `nbreKitRecu_${kit.id}`,
              label: 'Nombre reçu par la fille',
              type: 'number',
              value: 0,
              min: 0,
            },
    ...
    },
    {
      id: 12,
      title:
        'FICHE DE SUIVI DES ACTIVITES DES MARRAINES OU « DEUXIEMES MAMANS »',
      meta_thing: 'Natacha C. G. BAMEYNOU',
      icon: icons[generateRandom(icons.length)],
      variant: variants[generateRandom(variants.length)],
      get description() {
        ...
        return [
          [
            ...
            },
            {
              ...
              placeholder:
                "Veuillez entrer la date de déroulement de l'activité",
              value: new Date().toISOString(),
              dateFormat: 'DD-MM-YYYY',
              required: true,
              disabled: false,
    ...
    },
    {
      id: 14,
      title:
        'Fiche de suivi des activités communautaires des Leaders Religieux',
      meta_thing: 'Natacha C. G. BAMEYNOU',
      icon: icons[generateRandom(icons.length)],
      variant: variants[generateRandom(variants.length)],
      get description() {
